...
import { usePrices, formatPrice, formatPriceChange, getAssetDisplayName } from '@/hooks/usePrices';
    ...
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-slate-800 mb-4">Please log in to view your dashboard</h1>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3">
                ...
                <p className="mt-2 text-amber-700">
                  You need to complete identity verification before you can trade or withdraw funds.
                </p>
                <div className="mt-4">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-gradient-to-r from-primary-500 to-primary-600 rounded-lg p-6 text-white">
                      ...
                      <div className="text-3xl font-bold mt-1">
                        ${(parseFloat(balances.funding.totalUsdValue) + parseFloat(balances.trading.totalUsdValue)).toLocaleString()}
                      </div>
                      <div className="text-sm opacity-90 mt-2">
                        Funding: ${parseFloat(balances.funding.totalUsdValue).toLocaleString()} • 
                        Trading: ${parseFloat(balances.trading.totalUsdValue).toLocaleString()}
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        {balances.funding.balances.map((balance) => (
                          <div key={balance.asset} className="flex items-center justify-between p-4 bg-slate-50 rounded-lg">
                            <div className="flex items-center space-x-3">
                              <div className="w-10 h-10 bg-primary-100 rounded-full flex items-center justify-center">
                                <span className="text-primary-600 font-bold">
                                  {balance.asset === 'PAXG' ? '🥇' : balance.asset === 'USD' ? '$' : '💰'}
                                </span>
                              </div>
                              <div>
          ...
          <div className="space-y-6">
            ...
            <div className="card">
              <div className="card-header">
                ...
                <p className="card-description">Current precious metals prices</p>
              </div>
              <div className="card-content">
                {pricesLoading ? (
                  <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    {Object.entries(prices).map(([asset, priceData]) => {
                      ...
                      return (
                        <div key={asset} className="flex items-center justify-between p-3 rounded-lg hover:bg-slate-50">
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              <div className="font-medium">{getAssetDisplayName(asset)}</div>
            ...
            <div className="card">
              ...
              <div className="card-content space-y-3">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-sm text-slate-600">Trading Enabled</span>
                  <span className={`px-2 py-1 rounded text-xs ${
                    canTrade 
                      ? 'bg-green-100 text-green-800' 
                      : 'bg-red-100 text-red-800'
