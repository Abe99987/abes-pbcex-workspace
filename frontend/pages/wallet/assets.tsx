      ...
      <main className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8'>
          ...
          <div className='lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6'>
            ...
            <div className='bg-white rounded-lg shadow-sm border p-6'>
              ...
              <div className='text-3xl font-bold text-gray-900 mb-2'>
                $
                {balances
                  ? parseFloat(balances.trading.totalUsdValue).toLocaleString()
                  : '0'}
              </div>
            ...
            <div className='bg-white rounded-lg shadow-sm border p-6'>
              ...
              <div className='text-3xl font-bold text-gray-900 mb-2'>
                $
                {balances
                  ? parseFloat(balances.funding.totalUsdValue).toLocaleString()
                  : '0'}
              </div>
              <div className='flex items-center text-green-600'>
        ...
        <section className='mb-8'>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8'>
            {MY_ASSETS_SYMBOLS.slice(0, 4).map(symbol => (
              <div
                key={symbol}
          ...
          {/* Mini Charts for Additional Assets */}
          <div className='bg-white rounded-lg shadow-sm border p-6'>
            <h3 className='text-lg font-semibold text-gray-900 mb-4'>
              Additional Markets
            </h3>
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
              {MY_ASSETS_SYMBOLS.slice(4).map(symbol => (
