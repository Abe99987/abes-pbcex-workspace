...
export default function MySpending() {
  ...
  const totalSpending = SPENDING_CATEGORIES.reduce(
  ...
  const monthlyChange =
    currentMonthSpend && previousMonthSpend
      ? ((currentMonthSpend.amount - previousMonthSpend.amount) /
      ...
      <main className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8'>
          ...
          <div className='bg-white rounded-lg shadow-sm border p-6'>
            ...
            <div
              className={`flex items-center text-sm ${monthlyChange >= 0 ? 'text-red-600' : 'text-green-600'}`}
            >
              {monthlyChange >= 0 ? (
          ...
          <div className='bg-white rounded-lg shadow-sm border p-6'>
            ...
            <div className='text-sm text-gray-600'>
              {currentMonthSpend
                ? (
                    (currentMonthSpend.discretionary /
              ...
              {SPENDING_CATEGORIES.map(category => (
                ...
                >
                  ...
                  <div className='text-right'>
                    ...
                    <div
                      className={`text-xs ${category.change >= 0 ? 'text-red-600' : 'text-green-600'}`}
                    >
                      {category.change >= 0 ? '+' : ''}
