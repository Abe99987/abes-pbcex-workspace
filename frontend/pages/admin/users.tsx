                ...
                <tbody className='bg-white divide-y divide-gray-200'>
                  {filteredUsers.map(user => (
                    <tr key={user.id} className='hover:bg-gray-50'>
                      ...
                      <td className='px-6 py-4 whitespace-nowrap'>
                        <span
                          className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getKycStatusColor(user.kycStatus)}`}
                        >
                          {user.kycStatus}
                        </span>
                      </td>
                      ...
                      <td className='px-6 py-4 whitespace-nowrap text-sm font-medium'>
                        <div className='flex space-x-2'>
                          ...
                          <select
                            value={user.status}
                            onChange={e =>
                              toggleUserStatus(user.id, e.target.value as any)
                            }
              ...
              <div className='mt-3'>
                ...
                <div className='space-y-3'>
                  ...
                  <div>
                    ...
                    <span
                      className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getKycStatusColor(selectedUser.kycStatus)}`}
                    >
