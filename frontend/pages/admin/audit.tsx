    ...
    try {
      ...
      if (response.status === 200) {
        ...
        const mockData: AuditLogEntry[] = Array.from({ length: 20 }, (_, i) => ({
          ...
          action: ['LOGIN', 'LOGOUT', 'PASSWORD_CHANGE', 'KYC_SUBMIT', 'TRADE_PLACE'][Math.floor(Math.random() * 5)] || 'LOGIN',
          resource: ['auth', 'user', 'kyc', 'trade', 'wallet'][Math.floor(Math.random() * 5)] || 'auth',
