          ...
          <div className='max-w-4xl mx-auto'>
            ...
            <div className='space-y-8'>
                ...
                <div className='text-muted-foreground space-y-4'>
                  <ul className='space-y-2'>
                    <li className='flex items-start space-x-2'>
                      ...
                      <span>
                        You must be at least 18 years old (or local age of
                        majority) to use PBCEx services
                      </span>
                    </li>
                    <li className='flex items-start space-x-2'>
                      <div className='w-2 h-2 bg-gold rounded-full mt-2 flex-shrink-0'></div>
                    ...
                    <li className='flex items-start space-x-2'>
                      <div className='w-2 h-2 bg-gold rounded-full mt-2 flex-shrink-0'></div>
                      <span>
                        Completion of KYC (Know Your Customer) verification is
                        required
                      </span>
                    </li>
                    <li className='flex items-start space-x-2'>
                      <div className='w-2 h-2 bg-gold rounded-full mt-2 flex-shrink-0'></div>
                      <span>
                        Business accounts must complete KYB (Know Your Business)
                        verification
                      </span>
                    </li>
                    <li className='flex items-start space-x-2'>
                  ...
                  <div>
                    ...
                    <ul className='space-y-2 mt-2'>
                      <li className='flex items-start space-x-2'>
                        <div className='w-2 h-2 bg-gold rounded-full mt-2 flex-shrink-0'></div>
                        <span>
                          <strong>Funding Account:</strong> Holds real assets
                          and USD/USDC/PAXG for withdrawals and redemptions
                        </span>
                      </li>
                      <li className='flex items-start space-x-2'>
                        <div className='w-2 h-2 bg-gold rounded-full mt-2 flex-shrink-0'></div>
                        <span>
                          <strong>Trading Account:</strong> Contains synthetic
                          tokens (XAU-s, XAG-s, etc.) for fast trading
                        </span>
                      </li>
                    </ul>
                    <p className='mt-2'>
                      Synthetics remain platform-internal and withdrawals are
                      processed from the Funding account only.
                    </p>
                  </div>
                </div>
              </section>
              ...
              <section id='risks'>
                ...
                <div className='text-muted-foreground space-y-4'>
                  <p>
                    <strong>Important:</strong> Trading commodities and digital
                    assets involves significant risks:
                  </p>
                  <ul className='space-y-2'>
                    <li className='flex items-start space-x-2'>
                      <div className='w-2 h-2 bg-gold rounded-full mt-2 flex-shrink-0'></div>
                      <span>
                        <strong>Market Risk:</strong> Commodity prices can be
                        highly volatile
                      </span>
                    </li>
                    <li className='flex items-start space-x-2'>
                      <div className='w-2 h-2 bg-gold rounded-full mt-2 flex-shrink-0'></div>
                      <span>
                        <strong>Liquidity Risk:</strong> You may not be able to
                        sell assets when desired
                      </span>
                    </li>
                    <li className='flex items-start space-x-2'>
                      <div className='w-2 h-2 bg-gold rounded-full mt-2 flex-shrink-0'></div>
                      <span>
                        <strong>Custody Risk:</strong> Risk of loss associated
                    ...
                    <li className='flex items-start space-x-2'>
                      <div className='w-2 h-2 bg-gold rounded-full mt-2 flex-shrink-0'></div>
                      <span>
                        <strong>Regulatory Risk:</strong> Changes in laws may
                ...
                <div className='text-muted-foreground space-y-4'>
                  <ul className='space-y-2'>
                    <li className='flex items-start space-x-2'>
                      <div className='w-2 h-2 bg-gold rounded-full mt-2 flex-shrink-0'></div>
                      <span>
                        Physical redemption requests include a 10-minute price
                        lock period
                      </span>
                    </li>
                    <li className='flex items-start space-x-2'>
                      <div className='w-2 h-2 bg-gold rounded-full mt-2 flex-shrink-0'></div>
                      <span>
                        Shipping and insurance costs apply to physical
                        deliveries
                      </span>
                    </li>
                    <li className='flex items-start space-x-2'>
                      <div className='w-2 h-2 bg-gold rounded-full mt-2 flex-shrink-0'></div>
                      <span>
                        Minimum order sizes may apply for physical fulfillment
                      </span>
                    </li>
                    <li className='flex items-start space-x-2'>
                      <div className='w-2 h-2 bg-gold rounded-full mt-2 flex-shrink-0'></div>
                      <span>
                        Trading halts may occur during extreme market conditions
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <section id='fees'>
                ...
                <div className='text-muted-foreground space-y-4'>
                  ...
                  <p>
                    Current fee schedule is available on our platform and may be
                    updated with notice.
                  </p>
                </div>
              </section>
              ...
              <section id='arbitration'>
                ...
                <div className='text-muted-foreground space-y-4'>
                  <p>
                    <strong>For U.S. Users:</strong>
                  </p>
                  <ul className='space-y-2'>
                    <li className='flex items-start space-x-2'>
                      <div className='w-2 h-2 bg-gold rounded-full mt-2 flex-shrink-0'></div>
                      <span>
                        Most disputes will be resolved through binding
                        arbitration
                      </span>
                    </li>
                    <li className='flex items-start space-x-2'>
                    ...
                    <li className='flex items-start space-x-2'>
                      <div className='w-2 h-2 bg-gold rounded-full mt-2 flex-shrink-0'></div>
                      <span>
                        Small claims court disputes are excluded from
                        arbitration
                      </span>
                    </li>
                    <li className='flex items-start space-x-2'>
                      <div className='w-2 h-2 bg-gold rounded-full mt-2 flex-shrink-0'></div>
                      <span>
                        30-day opt-out window available after account creation
                      </span>
                    </li>
                  </ul>
                  <p>
                    Venue: Delaware, USA. Governing Law: Delaware State Law.
                  </p>
                </div>
              </section>
                ...
                <div className='text-muted-foreground space-y-4'>
                  ...
                  <ul className='space-y-2'>
                    <li className='flex items-start space-x-2'>
                      <div className='w-2 h-2 bg-gold rounded-full mt-2 flex-shrink-0'></div>
                      <span>
                        Suspend or terminate accounts for violations of these
                        terms
                      </span>
                    </li>
                    <li className='flex items-start space-x-2'>
                      <div className='w-2 h-2 bg-gold rounded-full mt-2 flex-shrink-0'></div>
                      <span>
                        Freeze synthetic tokens and burn compromised balances
                        for security
                      </span>
                    </li>
                    <li className='flex items-start space-x-2'>
                    ...
                    <li className='flex items-start space-x-2'>
                      <div className='w-2 h-2 bg-gold rounded-full mt-2 flex-shrink-0'></div>
                      <span>
                        Comply with legal orders and regulatory requirements
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <section id='intellectual'>
                ...
                <p className='text-muted-foreground'>
                  All PBCEx trademarks, logos, and content are our intellectual
                  property. You may not use our intellectual property without
                  written permission.
                </p>
              </section>
              ...
              <section id='liability'>
                ...
                <p className='text-muted-foreground'>
                  PBCEx's liability is limited to the maximum extent permitted
                  by law. We are not liable for indirect, incidental, or
                  consequential damages. Our total liability shall not exceed
