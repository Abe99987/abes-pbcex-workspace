...
const Licenses = () => {
  const currentLicenses = [
    ...
    },
    {
      ...
      status: 'Active',
      description:
        'Partnerships with regulated custodians for USD/USDC/PAXG storage',
    },
  ];
  ...
  const inProgress = [
    {
      ...
      description:
        'State money transmitter licensing for expanded U.S. operations',
    },
    {
      type: 'Money Transmitter License (MTL)',
          ...
          <div className='max-w-4xl mx-auto'>
            <div className='text-center mb-12'>
              ...
              <p className='text-xl text-muted-foreground'>
                Our regulatory compliance and operational certifications across
                global markets.
              </p>
            </div>
              ...
              <Card className='shadow-xl border-border/50 rounded-2xl'>
                ...
                <CardContent>
                  <p className='text-muted-foreground mb-6'>
                    We welcome security researchers to help us maintain the
                    highest security standards. If you discover a security
              ...
              <div className='text-center'>
                <Card className='shadow-xl border-gold/20 rounded-2xl bg-gradient-to-r from-gold/10 to-gold-light/10'>
                  <CardContent className='p-8'>
                    ...
                    <p className='text-muted-foreground mb-6'>
                      We're continuously expanding our regulatory footprint to
                      serve customers in new markets. Stay updated on our
                      licensing progress and new jurisdiction launches.
                    </p>
