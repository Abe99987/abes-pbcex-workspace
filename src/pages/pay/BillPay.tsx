...
import { Receipt, Plus, Calendar, Edit, Trash2, CheckCircle2 } from 'lucide-react';
...
const BillPay = () => {
  ...
  const handleSchedulePayment = () => {
    ...
    // Stub: would make API call here
    console.log('Schedule payment:', { schedulePayee, scheduleAmount, scheduleFrequency });
    // Reset form
    setSchedulePayee('');
    setScheduleAmount('');
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">Add payees and schedule one-time or recurring bills</p>
          </div>
            ...
            <CardContent>
              <Tabs value={activeTab} onValueChange={setActiveTab}>
                ...
                <TabsContent value="payees" className="space-y-6 mt-6">
                    ...
                    {mockPayees.map((payee) => (
                      ...
                      >
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center space-x-3">
                            <Badge 
                              variant={payee.status === 'active' ? 'default' : 'secondary'}
                            >
                              {payee.status}
                            </Badge>
                            <Button variant="ghost" size="sm" aria-label="Edit payee">
                              <Edit className="w-4 h-4" />
                            </Button>
                            <Button variant="ghost" size="sm" aria-label="Delete payee">
                  ...
                  {mockPayees.length === 0 && (
                    <div className="text-center py-12">
                      ...
                      <h3 className="text-lg font-semibold mb-2">No Payees Added</h3>
                ...
                <TabsContent value="schedule" className="space-y-6 mt-6">
                  ...
                  <Card>
                    <CardHeader>
                      <CardTitle className="text-lg">Schedule New Payment</CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className="space-y-2">
                          <Label htmlFor="schedule-payee">Payee</Label>
                          <Select value={schedulePayee} onValueChange={setSchedulePayee}>
                            <SelectTrigger id="schedule-payee" aria-label="Select payee">
                        ...
                        <div className="space-y-2">
                          ...
                          <Select value={scheduleFrequency} onValueChange={setScheduleFrequency}>
                            <SelectTrigger id="schedule-frequency" aria-label="Select frequency">
                      ...
                      <Button
                        ...
                        disabled={!schedulePayee || !scheduleAmount || !scheduleFrequency}
                        className="w-full"
                      >
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex-1">
                              <div className="flex items-center space-x-3">
                                <div>
                                  <div className="font-semibold">{schedule.payeeName}</div>
                                  <div className="text-sm text-muted-foreground">
