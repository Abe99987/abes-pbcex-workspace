...
import { QrCode, Copy, Mail, Share2, Calendar, DollarSign, Clock } from 'lucide-react';
...
const RequestPayment = () => {
  ...
  const isFormValid = asset && amount && parseFloat(amount) > 0;
            ...
            <div>
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Share this with people who need to pay you
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
