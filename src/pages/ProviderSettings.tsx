...
const mockAcceptedAssets = [
  ...
  {
    id: 'XPT-s',
    label: 'PBcex Synthetic Platinum (XPT-s)',
    checked: true,
    badge: 'Trade-Only (Internal)',
    tooltip:
      'Internal PBcex token; secure, freeze/burn capable; not transferable off PBcex.',
  ...
  {
    id: 'XPD-s',
    label: 'PBcex Synthetic Palladium (XPD-s)',
    checked: false,
    badge: 'Trade-Only (Internal)',
    tooltip:
      'Internal PBcex token; secure, freeze/burn capable; not transferable off PBcex.',
  ...
  {
    id: 'XCU-s',
    label: 'PBcex Synthetic Copper (XCU-s)',
    checked: false,
    badge: 'Trade-Only (Internal)',
    tooltip:
      'Internal PBcex token; secure, freeze/burn capable; not transferable off PBcex.',
  ...
  {
    id: 'USDC',
    label: 'Stablecoins (USDC/USDT)',
    checked: true,
    badge: 'Redeemable (External)',
    tooltip: 'USD-backed stablecoins',
  },
];
      ...
      <div className='max-w-4xl mx-auto px-4 py-8'>
        <div className='mb-8'>
          ...
          <p className='text-muted-foreground'>
            Configure your provider account preferences and payment options.
          </p>
        </div>
        ...
        <div className='space-y-6'>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Drag to reorder your preferred payment assets (optional priority
                order).
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className='space-y-2'>
                {mockAcceptedAssets
                  ...
                  .map((asset, index) => (
                    <div
                      key={asset.id}
                      className='flex items-center p-2 border rounded bg-muted/30'
                    >
                ...
                <div className='flex items-center justify-between'>
                  <div>
                    ...
                    <p className='text-sm text-muted-foreground'>
                      Allow direct fulfillment of orders
                    </p>
                  </div>
