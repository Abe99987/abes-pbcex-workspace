        ...
        <div className='max-w-6xl mx-auto'>
          ...
          <div className='mb-8'>
            ...
            <p className='text-muted-foreground'>
              Automate asset purchases with scheduled buying
            </p>
          </div>
                    ...
                    <CardContent className='space-y-6'>
                        ...
                        <div className='space-y-3'>
                          ...
                          <div className='flex items-center space-x-2'>
                            <input
                              ...
                              onChange={e => setEndType(e.target.value)}
                            />
                            <Label htmlFor='occurrences' className='mr-2'>
                              After
                            </Label>
                            <Input
                              type='number'
                      ...
                      <div className='space-y-2'>
                        ...
                        <Select
                          ...
                          onValueChange={setFundingAccount}
                        >
                          <SelectTrigger
                            id='funding'
                    ...
                    <CardContent className='space-y-4'>
                      ...
                      <Alert>
                        ...
                        <AlertDescription className='text-sm'>
                          DCA helps reduce the impact of volatility by spreading
                          purchases over time.
                        </AlertDescription>
                      </Alert>
                    </CardContent>
              ...
              <div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      See how your DCA strategy would have performed
                      historically
                    </CardDescription>
                  </CardHeader>
                  <CardContent className='space-y-6'>
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                      <div className='space-y-2'>
                        ...
                        <Select value={calcAsset} onValueChange={setCalcAsset}>
                          <SelectTrigger
                            id='calc-asset'
                            aria-label='Select asset for calculation'
                          >
                      ...
                      <div className='space-y-2'>
                        <Label htmlFor='calc-contribution'>
                          Contribution ($)
                        </Label>
                        <Input
                    ...
                    <div className='space-y-2'>
                      ...
                      <Select
                        value={calcFrequency}
                        onValueChange={setCalcFrequency}
                      >
                        <SelectTrigger
                          id='calc-frequency'
                          aria-label='Select calculation frequency'
                        >
                          <SelectValue placeholder='How often?' />
                        </SelectTrigger>
                        <SelectContent>
                    ...
                    {backtestResults ? (
                      <div className='space-y-4'>
                        <div className='grid grid-cols-2 gap-4'>
                          <div className='p-4 bg-muted rounded-lg'>
                            ...
                            <div className='text-2xl font-bold'>
                              ${backtestResults.totalInvested.toLocaleString()}
                            </div>
                          </div>
                          <div className='p-4 bg-muted rounded-lg'>
                            <div className='text-sm text-muted-foreground'>
                        ...
                        <Alert>
                          <Info className='w-4 h-4' />
                          <AlertDescription className='text-sm'>
                            For illustration only. Past performance does not
                      ...
                      <div className='text-center py-12'>
                        ...
                        <p className='text-muted-foreground'>
                          Fill out the form and click "Calculate Returns" to see
                          backtest results
                        </p>
                      </div>
                    )}
