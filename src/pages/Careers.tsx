...
const Careers = () => {
  ...
  const validateForm = () => {
    ...
    if (formType === 'developer') {
      if (!formData.roleInterested)
        newErrors.roleInterested = 'Role is required';
    } else if (formType === 'operations') {
      if (!formData.operationsRole)
        newErrors.operationsRole = 'Role is required';
    }
    ...
    <div className='space-y-6'>
      ...
      <div>
        ...
        <Select
          ...
          onValueChange={value => handleInputChange('roleInterested', value)}
        >
          <SelectTrigger
            className={errors.roleInterested ? 'border-destructive' : ''}
          >
  ...
  const renderOperationsForm = () => (
    <div className='space-y-6'>
      ...
      <div>
        ...
        <Select
          value={formData.operationsRole}
          onValueChange={value => handleInputChange('operationsRole', value)}
        >
          <SelectTrigger
            className={errors.operationsRole ? 'border-destructive' : ''}
          >
            <SelectValue placeholder='Select role' />
          </SelectTrigger>
          <SelectContent>
      ...
      <div>
        <Label htmlFor='operationsExperience'>
          Tell us about your customer support or operational experience
        </Label>
        <Textarea
          id='operationsExperience'
          value={formData.operationsExperience}
          onChange={e =>
            handleInputChange('operationsExperience', e.target.value)
          }
          rows={4}
          ...
          <div className='max-w-4xl mx-auto'>
            <div className='text-center mb-12'>
              ...
              <p className='text-xl text-muted-foreground'>
                We're building the world's first global asset-backed banking
                platform. Apply below as a developer or operations/customer
                support partner.
              </p>
            </div>
