...
const MyAssets = () => {
  ...
  const [transferDirection, setTransferDirection] = useState<
    'funding-to-trading' | 'trading-to-funding'
  >('funding-to-trading');
  ...
  const getAssetBadge = (symbol: string, category: 'funding' | 'trading') => {
    if (category === 'funding') {
      if (symbol === 'PAXG') {
        return {
          text: 'Redeemable (External)',
          variant: 'default' as const,
          tooltip:
            'Externally portable token; 1:1 backed; custody only—retail fulfillment via JM/DG.',
        };
      }
      ...
      return {
        text: 'Trade-Only (Internal)',
        variant: 'secondary' as const,
        tooltip:
          'Internal PBcex token; secure, freeze/burn capable; not transferable off PBcex.',
      };
    }
  };
            ...
            <div className='space-y-3'>
              <div className='flex justify-between items-center'>
                ...
                <span className='text-xl font-bold text-primary'>
                  $
                  {fundingTotal.toLocaleString(undefined, {
              ...
              <div className='flex justify-between items-center'>
                ...
                <span className='text-xl font-bold text-primary'>
                  $
                  {tradingTotal.toLocaleString(undefined, {
                    minimumFractionDigits: 2,
                    maximumFractionDigits: 2,
                  })}
                </span>
              ...
              <div className='flex justify-between items-center'>
                ...
                <span className='text-xl font-bold text-primary'>
                  $
                  {fxTotal.toLocaleString(undefined, {
                    minimumFractionDigits: 2,
                    maximumFractionDigits: 2,
                  })}
                </span>
              ...
              <div className='flex justify-between items-center'>
                ...
                <span className='text-xl font-bold text-primary'>
                  $
                  {mineralTotal.toLocaleString(undefined, {
                    minimumFractionDigits: 2,
                    maximumFractionDigits: 2,
                  })}
                </span>
              ...
              <div className='flex justify-between items-center'>
                ...
                <span className='text-xl font-bold text-primary'>
                  $
                  {cryptoTotal.toLocaleString(undefined, {
                    minimumFractionDigits: 2,
                    maximumFractionDigits: 2,
                  })}
                </span>
              ...
              <div className='flex justify-between items-center'>
                ...
                <span className='text-xl font-bold text-primary'>
                  $
                  {titledTotal.toLocaleString(undefined, {
                    minimumFractionDigits: 2,
                    maximumFractionDigits: 2,
                  })}
                </span>
                ...
                <PieChart>
                  ...
                  <RechartsTooltip
                    ...
                    labelFormatter={(name: string) =>
                      `${name} (${totalPortfolioValue > 0 ? (((chartData.find(d => d.name === name)?.value || 0) / totalPortfolioValue) * 100).toFixed(1) : '0.0'}%)`
                    }
                  />
                </PieChart>
              </ResponsiveContainer>
                      ...
                      <div className='lg:col-span-3 flex items-center space-x-4'>
                        ...
                        <div>
                          ...
                          <p className='text-xs text-muted-foreground mt-1'>
                            Prices powered by TradingView (Chainlink added
                            later).
                          </p>
                        </div>
                      </div>
                          ...
                          <div className='flex items-center gap-2'>
                            ...
                            <TooltipProvider>
                              <TooltipComponent>
                                ...
                                <TooltipContent>
                                  <p className='max-w-xs'>
                                    Internal PBcex token; secure, freeze/burn
                                    capable; not transferable off PBcex.
                                  </p>
                                </TooltipContent>
                              </TooltipComponent>
                            </TooltipProvider>
            ...
            <div className='space-y-4'>
              {titledAssets.map(asset => (
                <Card
                  ...
                  onClick={() =>
                    asset.symbol === 'HOME' && handleTitledAssetClick(asset)
                  }
                >
                  <CardContent className='p-6'>
                    <div className='grid grid-cols-1 lg:grid-cols-12 gap-6 items-center'>
