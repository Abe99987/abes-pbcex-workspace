    ...
    switch (activeSection) {
      case 'profile':
        return (
          <div className="space-y-6">
            <div>
              <h2 className="text-2xl font-bold mb-2">Profile & Contact Information</h2>
        ...
        return (
          <div className="space-y-6">
            <div>
              ...
              <p className="text-muted-foreground">Verify your identity to access all platform features.</p>
            </div>
      ...
      default:
        return (
          <div className="space-y-6">
            <div>
              <h2 className="text-2xl font-bold mb-2">{activeSection.charAt(0).toUpperCase() + activeSection.slice(1).replace('-', ' ')}</h2>
              <p className="text-muted-foreground">Coming soon - This feature is currently under development.</p>
            </div>
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-4">
        <nav className="text-sm text-muted-foreground">
          Account / {activeSection.charAt(0).toUpperCase() + activeSection.slice(1).replace('-', ' ')}
        </nav>
      </div>
