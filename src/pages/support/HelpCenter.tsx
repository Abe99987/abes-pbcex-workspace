  ...
  const quickLinks = [
    {
      ...
      description: 'Add funds or withdraw to your bank',
    },
    {
      icon: Settings,
      title: 'Account & KYC',
      description: 'Verify identity and manage settings',
    },
    {
      icon: FileText,
      title: 'Fulfillment/Realization',
      description: 'Physical asset delivery and redemption',
    },
    {
      icon: Shield,
          ...
          <div className='max-w-6xl mx-auto'>
            <div className='text-center mb-12'>
              ...
              <p className='text-xl text-muted-foreground'>
                We're here 24/7 to help with your wallet, trading, and
            ...
            <div className='mb-12'>
              ...
              <div className='grid md:grid-cols-4 gap-4'>
                {quickLinks.map(link => (
                  <Card
                    key={link.title}
                    className='border-border/50 rounded-2xl hover:shadow-lg transition-shadow cursor-pointer'
                  >
