  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-foreground mb-2">Large-Limit Offers</h1>
          <p className="text-muted-foreground">
            Join wholesale commodity offers with volume discounts. Groupon-style purchasing for metals and materials.
          </p>
        </div>
        ...
        <div className="mb-6 p-4 bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-lg">
          ...
          <p className="text-sm text-blue-600 dark:text-blue-400 mt-1">
            This is a preview of the Large-Limit marketplace. Backend integration required for full functionality.
          </p>
        </div>
            ...
            <Card key={post.id} className="overflow-hidden">
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                  <div>
                    <Label className="text-xs font-medium text-muted-foreground">MIN CONTRIBUTION</Label>
                  ...
                  <div>
                    <Label className="text-xs font-medium text-muted-foreground">VOLUME DISCOUNT</Label>
                    <p className="text-sm font-medium text-green-600">{post.volumeDiscount}</p>
                  </div>
                ...
                {/* Provider Accepts */}
                <div className="mb-4">
                  <Label className="text-xs font-medium text-muted-foreground">PROVIDER ACCEPTS:</Label>
                ...
                <div className="mb-4">
                  <div className="flex items-center justify-between mb-2">
                    <Label className="text-xs font-medium text-muted-foreground">COMMITTED / TARGET</Label>
                    <div className="flex items-center gap-4 text-sm">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <span>{post.committed} / {post.target} tons</span>
                      </div>
                    </div>
                  </div>
                  <Progress 
                ...
                <div className="flex items-center justify-between">
                  <p className="text-xs text-muted-foreground">
                    Allocations may be pro-rated. Final discount tier is based on total committed at cutoff.
                  </p>
        ...
        {mockPosts.length === 0 && (
          <Card className="text-center py-12">
            <CardContent>
              ...
              <h3 className="text-lg font-semibold mb-2">No Large-Limit Offers</h3>
              <p className="text-muted-foreground">
                There are currently no active large-limit offers. Check back later or contact providers directly.
              </p>
            </CardContent>
          </Card>
        )}
