                  ...
                  <div className='space-y-6'>
                    <div>
                      <span className='text-3xl font-bold text-foreground'>
                        {assetData.principalPayments}
                      </span>
                      <p className='text-sm text-muted-foreground'>
                        payments remaining
                      </p>
                      <p className='text-lg font-semibold text-foreground'>
                        ${assetData.principalPaymentAmount.toLocaleString()}{' '}
                        each
                      </p>
                    ...
                    <div>
                      <span className='text-3xl font-bold text-foreground'>
                        {assetData.maintenancePayments}
                      </span>
                      <p className='text-sm text-muted-foreground'>
                        payments remaining
                      </p>
                      <p className='text-lg font-semibold text-foreground'>
                        ${assetData.maintenancePaymentAmount.toLocaleString()}{' '}
                        each
                      </p>
                      <p className='text-xs text-muted-foreground mt-1'>
                        Maintenance Payments Remaining
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className='text-center space-y-6'>
                  ...
                  <div>
                    <p className='text-2xl font-bold text-foreground'>
                      ${assetData.payoffAmount.toLocaleString()} to own the
                      title
                    </p>
                  </div>
                  ...
                  <div className='flex items-center justify-center space-x-2'>
                    <span className='text-4xl font-bold text-foreground'>
                      {assetData.paymentsLeftToUnfreeze}
                    </span>
