        ...
        <div className='max-w-4xl mx-auto'>
          ...
          <div className='mb-8'>
            <h1 className='text-3xl font-bold text-foreground mb-2'>
              Spend with Visa Card
            </h1>
            <p className='text-muted-foreground'>
              Choose which asset to spend from your card
            </p>
          </div>
            ...
            <div className='lg:col-span-2 space-y-6'>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Select exactly one asset to fund transactions (priority
                    order applies if multiple enabled)
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <RadioGroup
                    value={fundingAsset}
                    onValueChange={setFundingAsset}
                  >
                    <div className='space-y-3'>
                  ...
                  {enabledAssets.length === 0 && (
                    <div className='text-center py-8'>
                      ...
                      <p className='text-muted-foreground'>
                        No assets enabled for spending
                      </p>
                      <p className='text-sm text-muted-foreground'>
                        Enable assets below to use them for funding
                      </p>
                    </div>
                  )}
                </CardContent>
                    ...
                    >
                      <div className='flex items-center justify-between'>
                        ...
                        <Switch
                          ...
                          onCheckedChange={() =>
                            handleAssetToggle(asset.symbol)
                          }
                        />
                      </div>
                    </div>
                ...
                <CardContent className='space-y-4'>
                  <Alert>
                    ...
                    <AlertDescription className='text-sm'>
                      If the selected funding asset has insufficient balance,
