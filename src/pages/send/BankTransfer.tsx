        ...
        <div className='max-w-4xl mx-auto'>
          ...
          <div className='mb-8'>
            ...
            <p className='text-muted-foreground'>
              Link a bank and send via SWIFT or compatible partner. KYC
              required.
            </p>
                  ...
                  <Tabs value={activeTab} onValueChange={setActiveTab}>
                    ...
                    <TabsContent value='transfer' className='space-y-6 mt-6'>
                      ...
                      <div className='space-y-4'>
                        ...
                        <div className='space-y-2'>
                          ...
                          <Select value={purpose} onValueChange={setPurpose}>
                            <SelectTrigger
                              id='purpose'
                              aria-label='Select transfer purpose'
                            >
                      ...
                      <Alert>
                        ...
                        <AlertDescription>
                          KYC verification required for international transfers.
                    ...
                    <TabsContent value='link' className='space-y-6 mt-6'>
                      <div className='text-center py-12'>
                        ...
                        <p className='text-muted-foreground mb-6'>
                          Connect your bank account for faster future transfers
                          and lower fees.
                        </p>
                  ...
                  <div className='mt-6 space-y-3'>
                    ...
                    <div className='p-3 bg-muted rounded-lg'>
                      <p className='text-xs text-muted-foreground'>
                        SWIFT network fees and exchange rates apply. Final
                        amount may vary.
                      </p>
                    </div>
                  </div>
      ...
      <Dialog open={summaryOpen} onOpenChange={setSummaryOpen}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleConfirm}>Submit Transfer</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </div>
