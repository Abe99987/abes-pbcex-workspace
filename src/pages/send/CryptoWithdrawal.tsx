...
const CryptoWithdrawal = () => {
  ...
  const availableNetworks = selectedAssetData
    ? networks.filter(n => selectedAssetData.networks.includes(n.id))
    : [];
        ...
        <div className='max-w-4xl mx-auto'>
          ...
          <div className='mb-8'>
            ...
            <p className='text-muted-foreground'>
              Withdraw to an external crypto address. Choose network/chain.
            </p>
          </div>
                ...
                <CardContent className='space-y-6'>
                  ...
                  {selectedNetwork && (
                    <div className='space-y-2'>
                      ...
                      <p className='text-xs text-muted-foreground'>
                        Make sure this is a valid {selectedNetworkData?.name}{' '}
                        address.
                        {selectedNetwork === 'BTC' &&
                  ...
                  {selectedAsset && selectedNetwork && (
                    <div className='space-y-2'>
                        ...
                        <Button
                          ...
                          onClick={() => {
                            if (selectedAssetData) {
                              setAmount(
                                selectedAssetData.balance.replace(',', '')
                              );
                            }
                          }}
                        >
                      ...
                      <p className='text-xs text-muted-foreground'>
                        Network fee will be deducted:{' '}
                        {selectedNetworkData?.fee || 'N/A'}
                      </p>
                    </div>
                  )}
                  ...
                  {selectedAsset && selectedNetwork && (
                    <div className='space-y-4'>
                      ...
                      <Alert>
                        ...
                        <AlertDescription>
                          Double-check the address. Crypto transactions are
                          irreversible.
                        </AlertDescription>
                      </Alert>
                    </div>
                ...
                <CardContent className='space-y-4'>
                  ...
                  <div className='mt-6 space-y-3'>
                    ...
                    <div className='p-3 bg-muted rounded-lg'>
                      <p className='text-xs text-muted-foreground'>
                        ETA: {selectedNetworkData?.time || 'Variable'} after
                        confirmation
                      </p>
                    </div>
                    <Alert>
                      ...
                      <AlertDescription className='text-xs'>
                        Withdrawals are irreversible. Verify all details before
                        proceeding.
                      </AlertDescription>
                    </Alert>
                  </div>
