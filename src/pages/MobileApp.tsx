  ...
  const features = [
    {
      ...
      description:
        'Wallet, trading, global payments, and franchise onboarding — everything you need in one powerful mobile application with seamless user experience.',
    },
    {
      icon: <Shield className='w-8 h-8 text-silver' />,
      title: 'Cross-Platform Security',
      description:
        'OTP + biometric login, app-level encryption, and hardware security module integration ensure your assets are protected across all devices.',
    },
    {
      icon: <GraduationCap className='w-8 h-8 text-blue-500' />,
      title: 'Education First',
      description:
        'In-app tutorials and simulated trades to onboard new users, helping them understand asset-backed banking and precious metals trading.',
    },
    {
      icon: <MapPin className='w-8 h-8 text-green-500' />,
      title: 'Franchise Access',
      description:
        'Customers can locate and connect with nearby PBCEx branches for deposits, withdrawals, and physical redemption of precious metals.',
    },
  ];
          ...
          <div className='max-w-6xl mx-auto'>
            ...
            <div className='text-center mb-16'>
              ...
              <p className='text-xl text-muted-foreground max-w-3xl mx-auto'>
                Take your asset-backed banking with you anywhere. Trade precious
                metals, make global payments, and manage your wealth from your
                mobile device.
              </p>
            </div>
            ...
            <Card className='bg-gradient-to-r from-gold/5 to-silver/5 border-gold/20'>
              <CardHeader className='text-center'>
                ...
                <CardDescription className='text-lg'>
                  Your mobile banking experience with institutional-level
                  protection
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className='grid md:grid-cols-3 gap-8'>
                  <div className='text-center'>
                    ...
                    <p className='text-sm text-muted-foreground'>
                      Face ID, Touch ID, and fingerprint recognition for secure
                      access
                    </p>
                  </div>
                  <div className='text-center'>
                    ...
                    <p className='text-sm text-muted-foreground'>
                      All communications and data storage use military-grade
                      encryption
                    </p>
                  </div>
                  <div className='text-center'>
                    ...
                    <p className='text-sm text-muted-foreground'>
                      Meets regulatory requirements in all supported
                      jurisdictions
                    </p>
                  </div>
                </div>
