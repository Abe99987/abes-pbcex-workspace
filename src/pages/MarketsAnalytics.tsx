...
const MarketsAnalytics = () => {
  ...
  const topMovers: TopMoverData[] = [
    { symbol: 'BTC', name: 'Bitcoin', price: '$43,567', change: '+1,234', changePercent: '+2.91%', volume: '$2.4B', sparklineData: [100, 105, 102, 108, 112, 109, 115] },
    { symbol: 'ETH', name: 'Ethereum', price: '$2,678', change: '+89', changePercent: '+3.44%', volume: '$1.2B', sparklineData: [100, 98, 105, 103, 110, 112, 108] },
    { symbol: 'SOL', name: 'Solana', price: '$98.45', change: '+4.23', changePercent: '+4.49%', volume: '$456M', sparklineData: [100, 103, 101, 107, 109, 105, 111] }
  ];
  ...
  const TableSection = ({ title, data }: { title: string; data: TopMoverData[] }) => (
    <Card className="bg-[#15171A] border-[#23262A]">
      <CardHeader className="pb-4">
        <CardTitle className="text-[#F2F3F5] text-lg font-semibold">{title}</CardTitle>
      </CardHeader>
      <CardContent className="space-y-3">
        {data.map((item, index) => (
          <div key={item.symbol} className="flex items-center justify-between py-2 border-b border-[#23262A] last:border-b-0">
            ...
            <div className="flex items-center space-x-4">
              <div className="text-right">
                ...
                <div className={`text-xs ${item.changePercent.startsWith('+') ? 'text-green-400' : 'text-red-400'}`}>
                  {item.changePercent}
                </div>
              </div>
              <MiniSparkline data={item.sparklineData} />
              <Button size="sm" variant="outline" className="bg-transparent border-[#23262A] text-[#F2F3F5] hover:bg-[#23262A]">
                Trade
              </Button>
            </div>
          </div>
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] text-[#F2F3F5]">
      ...
      <div className="border-b border-[#23262A] bg-[#111214] px-6 py-6">
        ...
        <p className="text-[#C8CDD3] mt-1">Overview & key metrics dashboard</p>
      </div>
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <Card className="bg-[#15171A] border-[#23262A]">
            ...
            <CardContent>
              <div className="text-center space-y-3">
                ...
                />
                <div className="text-2xl font-bold text-[#F2F3F5]">{fearGreedScore}</div>
                <Badge variant="secondary" className="bg-[#23262A] text-[#C8CDD3]">
                  {fearGreedLabel}
                </Badge>
          ...
          <Card className="bg-[#15171A] border-[#23262A]">
            ...
            <CardContent>
              <div className="text-center space-y-2">
                <div className="text-2xl font-bold text-green-400">{marketStats.marketCapDelta}</div>
          ...
          <Card className="bg-[#15171A] border-[#23262A]">
            ...
            <CardContent>
              <div className="text-center space-y-2">
                <div className="text-2xl font-bold text-red-400">{marketStats.volumeDelta}</div>
                <div className="text-[#C8CDD3] text-sm">24h change</div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-[#15171A] border-[#23262A]">
            ...
            <CardContent>
              <div className="text-center space-y-2">
                <div className="text-2xl font-bold text-[#F2F3F5]">{marketStats.gasPrice}</div>
        ...
        {/* Top Movers Section */}
        <div className="mb-8">
          <h2 className="text-xl font-bold text-[#F2F3F5] mb-4">Top Movers (24h)</h2>
