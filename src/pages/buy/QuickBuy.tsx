    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="space-y-6">
          <div>
            <h1 className="text-3xl font-bold text-foreground mb-2">Quick Buy</h1>
            <p className="text-muted-foreground">Buy crypto and precious metals instantly</p>
          </div>
      ...
      <Dialog open={!!selectedAsset} onOpenChange={() => setSelectedAsset(null)}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle>Buy {selectedAsset?.name}</DialogTitle>
          </DialogHeader>
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Button className="w-full">Pay from Account Balance</Button>
              <Button variant="outline" className="w-full">Use Card</Button>
            </div>
          </div>
        </DialogContent>
      </Dialog>
