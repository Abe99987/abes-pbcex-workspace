...
const Investors = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    toast({
      ...
      description:
        'Thank you for your interest. Our investor relations team will be in touch soon.',
    });
                  ...
                  <form onSubmit={handleSubmit} className='space-y-6'>
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={e =>
                          handleInputChange('aumRange', e.target.value)
                        }
                    ...
                    <div>
                      ...
                      >
                        <SelectTrigger
                          className={
                            errors.investorType ? 'border-destructive' : ''
                          }
                        >
                  ...
                  <div className='space-y-6'>
                    <div className='text-center py-8'>
                      ...
                      <p className='text-muted-foreground mb-6'>
                        Live dashboard with real-time metrics, financial
