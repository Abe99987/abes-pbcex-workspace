              ...
              <ResizablePanel defaultSize={75} minSize={60}>
                <div className='flex-1 min-h-[420px] border-b border-gray-800 bg-black flex flex-col'>
                  ...
                  <div className='flex-1'>
                    ...
                    selectedPair.includes('GOLD') ||
                      selectedPair.includes('XAU') ? (
                      <CommodityInfoPanel symbol='XAU' />
                    ) : selectedPair.includes('SILVER') ||
                      selectedPair.includes('XAG') ? (
                      <CommodityInfoPanel symbol='XAG' />
                    ) : selectedPair.includes('PLATINUM') ||
                      selectedPair.includes('XPT') ? (
                      <CommodityInfoPanel symbol='XPT' />
                    ) : selectedPair.includes('PALLADIUM') ||
                      selectedPair.includes('XPD') ? (
                      <CommodityInfoPanel symbol='XPD' />
                    ) : selectedPair.includes('COPPER') ||
                      selectedPair.includes('XCU') ? (
