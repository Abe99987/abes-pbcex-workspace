        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
          <div className='space-y-4'>
            <h3 className='text-lg font-semibold text-white'>
              Copper (COPPER) Rating Breakdown: 62.72/100
            </h3>
            <div className='space-y-4'>
