...
const FranchiseDemandCounter = () => {
  ...
  useEffect(() => {
    (window as { franchiseDemandStore?: unknown }).franchiseDemandStore =
      franchiseDemandStore;
    (window as { countFranchiseAsFive?: unknown }).countFranchiseAsFive =
                  ...
                  <table className='w-full'>
                    <thead className='bg-muted/50 sticky top-0'>
                      <tr>
                        ...
                        <th className='text-left p-4 font-semibold w-32'>
                          Demand
                        </th>
                      </tr>
                    </thead>
              ...
              {totalPages > 1 && (
                <div className='flex items-center justify-between'>
                  <p className='text-sm text-muted-foreground'>
                    ...
                    of {filteredAndSortedData.length} cities
                  </p>
                  <div className='flex items-center space-x-2'>
                    <Button
                      variant='outline'
