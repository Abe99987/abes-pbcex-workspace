...
const PressForm = ({ showHeader = true }: PressFormProps) => {
  ...
  const validateForm = () => {
    ...
    if (!formData.pressOrganization.trim()) newErrors.pressOrganization = "Press company/outlet is required";
          ...
          <div>
            ...
            <Select value={formData.mediaType} onValueChange={(value) => handleInputChange("mediaType", value)}>
              ...
              <SelectContent>
                ...
                <SelectItem value="marketing-collab">Marketing/Collab</SelectItem>
                <SelectItem value="other">Other</SelectItem>
              </SelectContent>
            </Select>
            {errors.mediaType && <p className="text-sm text-destructive mt-1">{errors.mediaType}</p>}
          </div>
