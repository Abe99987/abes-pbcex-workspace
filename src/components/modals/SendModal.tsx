    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className='sm:max-w-md bg-background border-border'>
        ...
        <div className='space-y-6'>
            ...
            <RadioGroup value={recipientType} onValueChange={setRecipientType}>
              <div className='flex items-center space-x-3 p-3 border rounded-lg'>
                ...
                <div className='flex-1'>
                  <Label htmlFor='pbcex-user' className='font-medium'>
                    PBcex User
                  </Label>
                  <div className='text-sm text-muted-foreground'>
                    Send to another PBcex user by username or email
                  </div>
                </div>
              </div>
              <div className='flex items-center space-x-3 p-3 border rounded-lg'>
                ...
                <div className='flex-1'>
                  <Label htmlFor='external-wallet' className='font-medium'>
                    External Wallet
                  </Label>
                  <div className='text-sm text-muted-foreground'>
          ...
          <div className='space-y-3'>
            <Label>
              {recipientType === 'pbcex-user'
                ? 'Username or Email'
                : 'Wallet Address'}
            </Label>
            <Input
              placeholder={
                recipientType === 'pbcex-user' ? 'user@example.com' : '0x...'
              }
              value={recipient}
                ...
                <div className='flex items-start gap-3'>
                  ...
                  <div className='text-sm'>
                    ...
                    <span className='text-yellow-700'>
                      Only redeemable tokens (like PAXG) can be sent to external
                      wallets. Trade-only tokens remain within the PBcex
                      ecosystem.
                    </span>
                  </div>
                </div>
