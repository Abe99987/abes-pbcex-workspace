...
const CryptoDepositModal = ({
  ...
  const networks = getNetworks().filter(network =>
    selectedTokenData?.networks.includes(network.id)
  );
  ...
  const getDepositAddress = () => {
    ...
    return (
      addresses[selectedNetwork as keyof typeof addresses] || addresses.ethereum
    );
  };
              ...
              <div className='flex items-start gap-3'>
                ...
                <div className='text-sm'>
                  ...
                  <span className='text-amber-700'>
                    ...
                    <br />• Use the{' '}
                    {networks.find(n => n.id === selectedNetwork)?.name} network
                    only
                    <br />
                    • Minimum deposit: Varies by token (typically $10-$100)
                    <br />• Deposits typically confirm within 3-15 minutes
                  </span>
                </div>
              </div>
            </CardContent>
