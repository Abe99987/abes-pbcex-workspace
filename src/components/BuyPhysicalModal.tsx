...
const BuyPhysicalModal = ({ isOpen, onClose, asset }: BuyPhysicalModalProps) => {
    ...
    switch (asset.symbol) {
      ...
      case "XCU": 
        return { 
          unit: "tons", 
          formats: [
            { id: "ingots", name: "Ingots", description: "High-grade copper ingots", minAmount: 1.0, icon: "🟤" },
            { id: "coils", name: "Coils", description: "Copper wire coils for industrial use", minAmount: 1.0, icon: "🔄" },
            { id: "sheets", name: "Sheets", description: "Flat copper sheets", minAmount: 1.0, icon: "📄" }
          ]
        };
      case "OIL": 
        return { 
          unit: "barrels", 
          formats: [
            { id: "delivery", name: "Physical Delivery", description: "Bulk industrial delivery (licensing required)", minAmount: 500000, icon: "🚛" }
          ]
        };
      default: 
  ...
  const handleConfirm = async () => {
    ...
    const deliveryETA = asset.symbol === "XCU" || asset.symbol === "OIL" 
            ...
            <>
              ...
              <div className="space-y-3">
                ...
                <Input
                  ...
                  step={asset.symbol === "OIL" ? "1000" : asset.symbol === "XCU" ? "0.1" : "0.01"}
                  className="text-lg"
                />
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="text-sm">
                        ...
                        <span className="text-yellow-700">
                          ...
                          Available for bulk industrial clients only (minimum 500,000 barrels).
                          Delivery ETA: 3–5 weeks via MRST Shipping.
                        </span>
                      </div>
                    </div>
                  </CardContent>
                ...
                <Card className="border-l-4 border-l-orange-500 bg-orange-50">
                  <CardContent className="p-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="text-sm">
                        <strong className="text-orange-800">Copper Delivery Notice</strong><br />
                        <span className="text-orange-700">
                          Delivery ETA: 3–5 weeks via MRST Shipping. 
                          Minimum order quantity: 1 ton per format.
                        </span>
                      </div>
                    </div>
                  </CardContent>
            ...
            <>
                  ...
                  <div className="space-y-3">
                    ...
                    >
                      <div className="flex items-center space-x-2">
                        ...
                        <Label htmlFor="fedex">
                          {asset.symbol === "XCU" || asset.symbol === "OIL" ? "MRST Shipping (3-5 weeks)" : "FedEx (2-3 business days)"}
                        </Label>
                      </div>
                  ...
                  <Card className="border-l-4 border-l-blue-500">
                    <CardContent className="p-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="text-sm">
                          <strong>Delivery insured by {asset.symbol === "XCU" || asset.symbol === "OIL" ? "MRST" : "Dillon Gage"}</strong><br />
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    <span>Amount:</span>
                    <span>{amount} {assetConfig.unit}</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Format:</span>
