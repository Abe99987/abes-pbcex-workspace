...
const BranchLocator = ({ onSelectBranch, selectedBranch }: BranchLocatorProps) => {
    ...
    <div className="space-y-4">
      ...
      <Card className="h-48 bg-muted flex items-center justify-center">
        <div className="text-center text-muted-foreground">
          ...
          <div className="text-xs">Showing {filteredBranches.length} branches near you</div>
        </div>
      </Card>
            ...
            <CardContent className="p-4">
              ...
              <div className="flex justify-between items-center">
                <div className="text-xs">
                  ...
                  <span className="font-medium text-green-600">{branch.spread}</span>
                </div>
                <Button 
                  size="sm" 
