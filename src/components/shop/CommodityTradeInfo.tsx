    ...
    <div className="space-y-6 text-white p-4">
      ...
      <div>
        ...
        <div className="space-y-3">
          <div>
            <span className="text-gray-400 text-sm block mb-2">Accepted Tender</span>
          ...
          <div>
            <span className="text-gray-400 text-sm block mb-2">Order Types</span>
            <div className="flex flex-wrap gap-2">
          ...
          {meta.barterRules.allow && (
            <div>
              <span className="text-gray-400 text-sm block mb-1">Barter Orders</span>
      ...
      {/* Risk & Hedging */}
      <div>
        <h4 className="text-gray-300 text-lg font-semibold mb-4">Risk Management</h4>
        <div className="space-y-3">
          <div>
            <span className="text-gray-400 text-sm block mb-1">Hedge Methods</span>
            <p className="text-xs text-gray-300">{meta.hedgeMethod.join(', ')}</p>
          </div>
          <div>
            <span className="text-gray-400 text-sm block mb-1">Hedge Latency</span>
            <p className="text-xs text-gray-300">{meta.hedgeLatencyTarget}</p>
          </div>
          <div>
            <span className="text-gray-400 text-sm block mb-1">Inventory Policy</span>
            <p className="text-xs text-gray-300">{meta.inventoryPolicy}</p>
          </div>
          <div className="flex items-center gap-2">
            <span className="text-gray-400 text-sm">Provider Co-Market Making</span>
            <Badge variant={meta.providerCoMM ? "default" : "secondary"} className="text-xs">
      ...
      <div>
        ...
        <div className="space-y-3">
          <div>
            <span className="text-gray-400 text-sm block mb-2">Shipping Options</span>
            <div className="flex flex-wrap gap-2">
      ...
      {meta.disclosures.length > 0 && (
        <div>
          <h4 className="text-gray-300 text-lg font-semibold mb-4">Disclosures</h4>
