...
const SavingsRateCard = ({ 
  ...
  const getTieredCopy = () => {
    if (currentRate >= 0.25) return "Excellent discipline. Put excess to work in metals or other assets.";
    if (currentRate >= 0.20) return "You're ahead. Convert surplus into diversified assets.";
    if (currentRate >= 0.15) return "Great pace. Automate investing your surplus each month.";
    return "";
  };
  ...
  const handleConvertToAssets = () => {
    ...
    navigate(`/trading?action=buy&asset=${selectedAsset}&amount=${surplus}&source=my-spending-savings-nudge`);
  };
        ...
        {showCTA && (
          <div className="bg-primary/10 rounded-lg p-4 space-y-3">
            ...
            <div className="flex items-center space-x-2">
              ...
              >
                Convert ${surplus} to {selectedAsset.charAt(0).toUpperCase() + selectedAsset.slice(1)}
