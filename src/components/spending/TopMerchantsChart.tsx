...
interface TooltipProps {
  active?: boolean;
  payload?: Array<{
    payload: MerchantTrend & { displayName: string };
  }>;
  label?: string;
}
      ...
      return (
        <div className='bg-card border border-border rounded-lg p-3 shadow-lg'>
          ...
          <p className='text-sm text-muted-foreground'>
            This Month: $
            {data.currentMonth.toLocaleString(undefined, {
