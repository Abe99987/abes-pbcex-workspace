      ...
      <div className='container mx-auto px-4'>
        <div className='text-center mb-12'>
          ...
          <p className='text-xl text-muted-foreground max-w-3xl mx-auto'>
            Learn why gold and silver have been trusted stores of value for
            thousands of years, and how modern technology makes them accessible
            to everyone.
          </p>
        </div>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto'>
          ...
          <div className='space-y-8'>
            <Card className='border-gold/20 bg-card/80 backdrop-blur'>
              ...
              <CardContent>
                <p className='text-muted-foreground leading-relaxed'>
                  In 1971, the US removed the gold standard, allowing unlimited
                  money printing. Since then, the dollar has lost over 85% of
                  its purchasing power while gold has maintained its value
                  across millennia.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className='border-silver/20 bg-card/80 backdrop-blur'>
              ...
              <CardContent>
                <p className='text-muted-foreground leading-relaxed'>
                  Inflation silently erodes your savings. What cost $1 in 1971
                  now costs over $6. Asset-backed money protects your wealth
                  from this invisible tax on your financial future.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className='border-primary/20 bg-card/80 backdrop-blur'>
              ...
              <CardContent>
                <p className='text-muted-foreground leading-relaxed'>
                  Our blockchain technology allows you to own fractions of
                  physical gold and silver, making precious metals as liquid as
                  cash while maintaining their intrinsic value and inflation
                  protection.
                </p>
              </CardContent>
            </Card>
              ...
              <div className='space-y-6'>
                ...
                <div className='flex items-start space-x-4'>
                  ...
                  <div>
                    ...
                    <p className='text-muted-foreground text-sm'>
                      Precious metals are recognized worldwide as stores of
                      value
                    </p>
                  </div>
                </div>
                ...
                <div className='flex items-start space-x-4'>
                  ...
                  <div>
                    ...
                    <p className='text-muted-foreground text-sm'>
                      Spend your gold as easily as digital cash with our
                      platform
                    </p>
                  </div>
                </div>
