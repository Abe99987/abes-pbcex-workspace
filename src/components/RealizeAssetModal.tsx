...
const RealizeAssetModal = ({
  isOpen,
  onClose,
  asset,
}: RealizeAssetModalProps) => {
          ...
          formats: [
            {
              id: 'bar',
              name: 'Silver Bar',
              description: 'Pure .999 silver bars',
              minAmount: 10.0,
              icon: '🥈',
            },
            {
          ...
          formats: [
            {
              id: 'cash',
              name: 'Physical Cash',
              description: 'Libyan Dinar banknotes',
              minAmount: 50,
              icon: '💴',
            },
            {
              id: 'bank',
              name: 'Bank Transfer',
              description: 'Direct transfer to Libyan bank',
              minAmount: 100,
              icon: '🏦',
            },
          ],
          ...
          formats: [
            {
              id: 'sell',
              name: 'Sell to Market',
              description: 'Convert back to USD at current price',
              minAmount: 0.01,
              icon: '💰',
            },
            {
  ...
  const getRedemptionBreakdown = () => {
    ...
    if (asset.symbol === 'LYD') {
      ...
      if (format === 'sell') {
        return `${units.toFixed(3)} barrels → $${(units * 78.2).toFixed(2)} USD`;
      } else {
            ...
            <CardContent className='p-4'>
              <div className='flex justify-between items-center'>
                ...
                <span className='font-bold text-lg'>
                  {assetConfig.userBalance.toFixed(3)} {assetConfig.unit}
                </span>
              </div>
            </CardContent>
          </Card>
            ...
            <>
              ...
              <div className='space-y-3'>
                ...
                <div className='text-sm text-muted-foreground'>
                  Maximum: {assetConfig.userBalance.toFixed(3)}{' '}
                  {assetConfig.unit} available
                  <br />
                    ...
                    <div className='flex items-start gap-3'>
                      ...
                      <div className='text-sm'>
                        ...
                        <span className='text-yellow-700'>
                          ...
                          clients only (minimum 100 barrels).
                        </span>
                      </div>
                    </div>
                  </CardContent>
              ...
              <div className='space-y-3'>
                ...
                >
                  <div className='flex items-center space-x-3 p-4 border rounded-lg'>
                    <RadioGroupItem
                      value='pbcex-tokens'
                      id='realize-pbcex-tokens'
                    />
                    <div className='flex-1'>
                      <Label
                        htmlFor='realize-pbcex-tokens'
                        className='font-medium'
                      >
                        PBcex Tokens
                      </Label>
                      <div className='text-sm text-muted-foreground'>
                        Burn tokens and receive proceeds
                      </div>
                    </div>
                  </div>
                  <div className='flex items-center space-x-3 p-4 border rounded-lg'>
                    ...
                    <div className='flex-1'>
                      <Label htmlFor='realize-usd' className='font-medium'>
                        USD
                      </Label>
                      <div className='text-sm text-muted-foreground'>
                        Receive US Dollars
                  ...
                  <div className='flex items-center space-x-3 p-4 border rounded-lg'>
                    ...
                    <div className='flex-1'>
                      <Label htmlFor='realize-usdc' className='font-medium'>
                        USDC/USDT
                      </Label>
                      <div className='text-sm text-muted-foreground'>
                        Receive stablecoins
                          ...
                          parseFloat(amount) > 0 && (
                            <div className='mt-2 pt-2 border-t'>
                              <div className='text-green-700'>
                                Payment: {parseFloat(amount).toFixed(3)} PBcex{' '}
                                {asset.symbol} (internal) → $
                                {(parseFloat(amount) * 2000).toFixed(2)} applied
                              </div>
                            </div>
                          )}
                      </div>
                ...
                <Card className='bg-green-50 border-green-200'>
                  <CardContent className='p-6 text-center'>
                    ...
                    <h3 className='font-bold text-green-800 mb-2'>
                      Market Sale Confirmation
                    </h3>
                    <p className='text-green-700 mb-4'>
                      Your {amount} barrels of oil will be sold at the current
                      market rate of $78.20 per barrel.
                    </p>
                    <div className='text-lg font-bold text-green-800'>
                      You will receive: $
                      {((parseFloat(amount) || 0) * 78.2).toFixed(2)} USD
                    </div>
                  </CardContent>
                </Card>
              ) : (
                    ...
                    <Card className='border-l-4 border-l-blue-500'>
                      <CardContent className='p-4'>
                        <div className='flex items-start gap-3'>
                          ...
                          <div className='text-sm'>
                            <strong>Delivery insured by Dillon Gage</strong>
                            <br />
                        ...
                        <CardContent className='p-4'>
                          <div className='flex items-start gap-3'>
                            ...
                            <div className='text-sm'>
                              ...
                              <br />
                              All transfers are processed through verified
                              Libyan banking networks with full compliance.
                            </div>
                          </div>
                        </CardContent>
                      </Card>
                ...
                <CardContent className='p-4 space-y-3'>
                  ...
                  <div className='flex justify-between text-sm'>
                    ...
                    <span>
                      {asset.symbol === 'OIL' && format === 'sell'
                        ? 'Instant'
                        : asset.symbol === 'LYD' && deliveryMethod === 'bank'
                          ? '1-2 business days'
                          : deliveryMethod === 'ship'
                            ? '2-3 business days'
